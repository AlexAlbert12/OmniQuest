...
test('admin security uses the lightweight context, explicit More navigation and the shared purple admin back action', () => {
  ...
  assert.match(security, /<AppBackButton[\s\S]*label="Volver a Más" role="admin"/)
