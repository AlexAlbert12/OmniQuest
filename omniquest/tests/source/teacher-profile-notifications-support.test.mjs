...
test('support conversations expose paged tickets, attachments, contact channels and email history', () => {
  ...
  assert.match(help, /Cargar más tickets/)
  assert.match(help, /Cargar mensajes anteriores/)
  assert.match(help, /Canal de respuesta preferido/)
  assert.match(help, /Historial de emails enviados/)
  assert.match(help, /Cargar más emails/)
