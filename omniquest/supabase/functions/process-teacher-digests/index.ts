...
function renderDigest(d: Digest) {
  ...
  return `<!doctype html><html><body style="font-family:Arial,sans-serif;background:#f4f7fb;padding:24px"><div style="max-width:640px;margin:auto;background:white;border-radius:16px;padding:28px"><h1 style="color:#172554">Resumen ${d.frequency === 'weekly' ? 'semanal' : 'diario'} de OmniQuest</h1><p style="color:#475569">Información agrupada según tus preferencias docentes.</p><table style="width:100%;border-collapse:collapse"><tr><td style="padding:14px;border:1px solid #e2e8f0">Alumnos sin actividad</td><td style="padding:14px;border:1px solid #e2e8f0;font-weight:bold">${inactive}</td></tr><tr><td style="padding:14px;border:1px solid #e2e8f0">Revisiones pendientes</td><td style="padding:14px;border:1px solid #e2e8f0;font-weight:bold">${reviews}</td></tr><tr><td style="padding:14px;border:1px solid #e2e8f0">Alertas de auditoría</td><td style="padding:14px;border:1px solid #e2e8f0;font-weight:bold">${sensitive}</td></tr></table><p style="margin-top:24px;color:#64748b;font-size:12px">Puedes cambiar la frecuencia o darte de baja desde Ajustes docentes.</p></div></body></html>`
}
