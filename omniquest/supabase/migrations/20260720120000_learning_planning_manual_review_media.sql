-- Learning planning, advanced manual review and rich media for questions.
...
-- The bucket is public for delivery, but only teachers/admins can write to their
-- own folder. The database still validates that media belongs to a question
...
-- ---------------------------------------------------------------------------
-- Teacher planning and student tasks
-- ---------------------------------------------------------------------------
...
-- Preserve feedback created before the threaded review system. Legacy notes were
-- visible to students, so they become student-facing comments exactly once.
