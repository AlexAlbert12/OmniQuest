      ...
      <View className="overflow-hidden bg-background-secondary" style={{ minHeight: Math.max(height, 760), borderRadius: isWeb ? 0 : 34 }}>
        ...
        <View className="z-10 flex-1 items-center justify-center" style={{ paddingHorizontal: isDesktop ? 32 : 22, paddingVertical: 32 }}>
          ...
          <View className="items-center px-2">
            ...
            <Text style={{ fontFamily: 'Pacifico_400Regular', fontSize: isDesktop ? 21 : 16 }} className="mt-1 text-center text-semantic-info">
          ...
          <AuthCard
            ...
            footer={(
              <View className="flex-row flex-wrap items-center justify-center gap-1">
                <Text className="text-[13px] font-semibold text-text-muted">¿No tienes cuenta de alumno?</Text>
                <Link href="/register" asChild>
                  <Pressable accessibilityRole="link" hitSlop={6}><Text className="text-[13px] font-extrabold text-semantic-info">Regístrate aquí.</Text></Pressable>
                </Link>
              </View>
            )}
          >
            ...
            <View className="flex-row items-center justify-end">
              <Link href="/forgot-password" asChild>
                <Pressable accessibilityRole="link" hitSlop={6}><Text className="text-[13px] font-bold text-semantic-info">¿Olvidaste tu contraseña?</Text></Pressable>
              </Link>
            </View>
