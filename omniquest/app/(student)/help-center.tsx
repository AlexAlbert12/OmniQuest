...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Entra en Perfil o en la sección Logros para revisar las conseguidas y pendientes.',
  },
  {
    question: '¿Cómo recupero acceso si olvidé la contraseña?',
    answer: 'Desde login usa recuperación de contraseña o cámbiala en Configuración si tienes sesión.',
  },
]
    ...
    <View className="flex-1 bg-background-primary">
      ...
      >
        ...
        <View className="mb-5 flex-row items-center gap-3 rounded-2xl border border-border-default bg-surface-default px-4 py-3">
          ...
          <Text className="min-w-0 flex-1 text-[13px] leading-5 text-text-secondary">Hola, soy Omni. Busca una respuesta o cuéntame qué problema tienes.</Text>
        </View>
        ...
        <View className={isDesktop ? 'flex-row gap-5' : 'gap-5'}>
          ...
          <Panel title="Contacto rápido" className={isDesktop ? 'w-[360px]' : ''}>
            <Text className="text-[13px] leading-6 text-text-secondary">
        ...
        <View className={isDesktop ? 'mt-5 flex-row gap-5' : 'mt-5 gap-5'}>
          <Panel title="Crear ticket" className={isDesktop ? 'flex-1' : ''}>
            ...
            <Pressable
              ...
              disabled={submitting}
              className="mt-4 flex-row items-center justify-center gap-2 rounded-xl bg-brand-student py-3"
