...
export default function TeacherHeaderAvatar() {
  const router = useRouter();
  const [profile, setProfile] = React.useState<TeacherProfile>({ alias: null, avatar: null });
  ...
  return (
    <Pressable
      accessibilityLabel="Abrir perfil del profesor"
