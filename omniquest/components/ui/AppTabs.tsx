...
const styles = StyleSheet.create({
  ...
  tab: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7, borderWidth: 1, borderRadius: 11, flexShrink: 0 },
  regularTab: { minHeight: 42, paddingHorizontal: 14 },
  compactTab: { minHeight: 36, paddingHorizontal: 11 },
  mobileRailTab: { minHeight: 42, minWidth: 88, flexShrink: 0, paddingHorizontal: 12 },
  fillTab: { flex: 1, minWidth: 0 },
  label: { minWidth: 0, flexShrink: 1, textAlign: 'center', fontWeight: '900', includeFontPadding: false },
