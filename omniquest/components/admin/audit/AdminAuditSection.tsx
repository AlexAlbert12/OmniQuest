    ...
    <AdminScaffold activeSection="audit" title="Auditoría" subtitle="Consulta y verifica los cambios administrativos registrados en el portal." data={data}>
      <Panel title="Integridad del registro" icon="finger-print-outline" className="mt-5">
        <View className="flex-row flex-wrap items-center justify-between gap-3">
          ...
          <View style={!responsive.isDesktop ? { width: '100%' } : undefined}><AdminButton label={verifying ? 'Verificando...' : 'Verificar integridad'} icon="shield-checkmark-outline" size="sm" variant="primary" fullWidth={!responsive.isDesktop} disabled={verifying} onPress={() => void verifyIntegrity()} /></View>
        </View>
