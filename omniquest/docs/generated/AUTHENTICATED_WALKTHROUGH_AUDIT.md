...
Estado acumulado hasta: 20260811104500_manual_review_owner_only_simplification.sql

## Resumen

- Archivos cliente inspeccionados: 431
...
| edge | `teacher-update-subject` | `components/teacher/TeacherSubjectForm.tsx` | 224 |
...
| rpc | `create_subject_with_default_topic` | `components/teacher/TeacherSubjectForm.tsx` | 250 |
...
| rpc | `ensure_default_classroom` | `components/teacher/question-form/useTeacherQuestionForm.ts` | 351 |
| rpc | `equip_profile_cosmetics` | `lib/avatarCosmetics.ts` | 118 |
| rpc | `finish_game_attempt` | `hooks/useGame.ts` | 262 |
...
| rpc | `get_safe_game_questions_v2` | `hooks/useGame.ts` | 172 |
...
| rpc | `save_teacher_question_v2` | `components/teacher/question-form/useTeacherQuestionForm.ts` | 657 |
...
| rpc | `start_game_attempt` | `hooks/useGame.ts` | 195 |
| rpc | `submit_answer_resumable` | `hooks/useGame.ts` | 421 |
...
| table | `classrooms` | `components/teacher/question-form/useTeacherQuestionForm.ts` | 339 |
| table | `classrooms` | `components/teacher/question-form/useTeacherQuestionForm.ts` | 353 |
...
| table | `enrollments` | `components/teacher/TeacherSubjectForm.tsx` | 149 |
...
| table | `profiles` | `components/teacher/TeacherSidebar.tsx` | 73 |
...
| table | `questions` | `components/teacher/question-form/useTeacherQuestionForm.ts` | 341 |
...
| table | `subject_topics` | `components/teacher/question-form/useTeacherQuestionForm.ts` | 794 |
...
| table | `subjects` | `components/teacher/question-form/useTeacherQuestionForm.ts` | 338 |
| table | `subjects` | `components/teacher/TeacherSubjectForm.tsx` | 120 |
