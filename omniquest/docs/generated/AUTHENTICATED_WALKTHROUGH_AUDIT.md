...
Estado acumulado hasta: 20260813150000_teacher_student_directory_avatars.sql
...
| edge | `student-reset-own-progress` | `hooks/useSettingsData.ts` | 230 |
...
| edge | `teacher-reset-own-data` | `hooks/useSettingsData.ts` | 249 |
...
| rpc | `get_safe_game_questions_v2` | `hooks/useGame.ts` | 170 |
...
| rpc | `get_teacher_notification_settings` | `components/support/RoleHelpCenter.tsx` | 151 |
...
| rpc | `request_account_deletion` | `hooks/useSettingsData.ts` | 564 |
...
| rpc | `search_app_entities` | `components/search/GlobalSearchButton.tsx` | 68 |
...
| rpc | `set_teacher_support_preference` | `components/support/RoleHelpCenter.tsx` | 292 |
| rpc | `start_game_attempt` | `hooks/useGame.ts` | 192 |
| rpc | `submit_answer_resumable` | `hooks/useGame.ts` | 418 |
...
| table | `profiles` | `hooks/useSettingsData.ts` | 271 |
| table | `profiles` | `hooks/useSettingsData.ts` | 499 |
...
| table | `subjects` | `components/support/RoleHelpCenter.tsx` | 148 |
...
| table | `subjects` | `hooks/useSettingsData.ts` | 432 |
...
| table | `user_notification_preferences` | `hooks/useSettingsData.ts` | 395 |
| table | `user_notification_preferences` | `hooks/useSettingsData.ts` | 449 |
...
| table | `user_preferences` | `hooks/useSettingsData.ts` | 378 |
| table | `user_preferences` | `hooks/useSettingsData.ts` | 427 |
